                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    ...
                                    <a href="{{ route('admin.roles.permissions', $role) }}" class="btn btn-outline-info" title="Permissions">
                                        <i class="bi bi-key"></i>
                                    </a>
                                    ...
                                    <button type="button" class="btn btn-outline-danger" title="Delete" onclick="confirmDelete({{ $role->id }})">
