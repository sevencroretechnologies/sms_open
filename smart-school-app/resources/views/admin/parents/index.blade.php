...
<div x-data="{ search: '{{ request('search') }}' }">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4">
        <div>
            <h1 class="h3 mb-1">Parents / Guardians</h1>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div>
                                        <span class="fw-medium">{{ $parent->user->name ?? 'N/A' }}</span>
                            ...
                            <td>{{ $parent->phone ?? '-' }}</td>
                            <td>
                                <span class="badge bg-light text-dark">{{ $parent->students_count ?? 0 }}</span>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    <a href="{{ route('admin.parents.show', $parent) }}" class="btn btn-outline-primary" title="View">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.parents.edit', $parent) }}" class="btn btn-outline-warning" title="Edit">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <button type="button" class="btn btn-outline-danger" title="Delete" onclick="confirmDelete({{ $parent->id }})">
