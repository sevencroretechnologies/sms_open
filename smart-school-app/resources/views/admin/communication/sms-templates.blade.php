...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header">
            <i class="bi bi-file-text me-2"></i>Templates List
        </div>
                ...
                <tbody>
                    @forelse($templates ?? [] as $index => $template)
                        <tr>
                            ...
                            <td><span class="badge bg-light text-dark">{{ $template->category ?? 'General' }}</span></td>
                            <td>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    <a href="{{ route('admin.sms.templates.edit', $template->id) }}" class="btn btn-outline-warning" title="Edit">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <form action="{{ route('admin.sms.templates.destroy', $template->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure?')">
                                        @csrf
                                        @method('DELETE')
                        ...
                        <tr>
                            <td colspan="6" class="text-center py-5">
                                <div class="text-muted">
                                    <i class="bi bi-chat-text fs-1 d-block mb-2"></i>
