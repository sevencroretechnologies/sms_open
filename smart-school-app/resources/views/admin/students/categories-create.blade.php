{{-- Student Category Create/Edit View --}}
{{-- Admin student category form --}}
    ...
    <div class="row">
        <div class="col-lg-8">
            <x-card>
                ...
                <form action="{{ isset($category) ? route('admin.student-categories.update', $category) : route('admin.student-categories.store') }}" method="POST">
                    @csrf
                    @if(isset($category))
                        @method('PUT')
                    @endif
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-lg me-1"></i> {{ isset($category) ? 'Update' : 'Create' }} Category
                        </button>
                    </div>
                </form>
            </x-card>
        ...
        <div class="col-lg-4">
            <x-card>
                ...
                <ul class="list-unstyled mb-0 small">
                    ...
                    <li class="mb-2">
                        <i class="bi bi-check-circle text-success me-2"></i>
                        Categories help organize students
                    </li>
                    <li class="mb-0">
                        <i class="bi bi-check-circle text-success me-2"></i>
                        Inactive categories won't appear in forms
                    </li>
                </ul>
            </x-card>
        </div>
