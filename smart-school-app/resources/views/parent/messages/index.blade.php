        ...
        <div class="col-lg-3 mb-4">
            <x-card>
                <div class="d-grid gap-2">
                    ...
                    <hr>
                    <a href="{{ route('parent.messages.index') }}" class="btn btn-outline-primary">
            ...
            <x-card title="Inbox">
                ...
                <div class="list-group">
                    @forelse($messages as $messageRecipient)
                        ...
                        <a href="{{ route('parent.messages.show', $message->id) }}" class="list-group-item list-group-item-action {{ !$messageRecipient->read_at ? 'bg-light' : '' }}">
