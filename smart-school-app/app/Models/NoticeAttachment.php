 ...
 * 
 * Prompt 408: Create Notice Attachment Model
 * 
 * Stores metadata for notice attachments including PDFs, images,
 * and other files uploaded with school notices.
 */
class NoticeAttachment extends Model
{
    ...
    /**
     * Get the notice that owns the attachment.
     *
     * @return BelongsTo
     */
